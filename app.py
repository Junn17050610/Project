...
class Config:
    ...
    MODEL_PATH = os.getenv('MODEL_PATH', 'models/model_weather_cnn_20251119_135654.h5')
    METADATA_PATH = os.getenv('METADATA_PATH', 'results/metadata_20251119_141228.json')
