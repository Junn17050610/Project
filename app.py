...
class Config:
    ...
    MODEL_PATH = os.getenv('MODEL_PATH', 'models/model_weather_cnn_20251117_142933.h5')
    METADATA_PATH = os.getenv('METADATA_PATH', 'results/model_metadata_20251117_142933.json')
